...
buttons = [
    ...
    InlineKeyboardButton(
        ...
        InlineKeyboardButton(text="🆕𝐍𝐄𝐖🆕", callback_data="New_"),
...
@run_async
def new_callback(update: Update, context: CallbackContext):
    query = update.callback_query
    query.answer()
    ...
    if query.data == "New_":
        ...
        # Send the custom message for the New_ callback with the same inline button
        context.bot.send_message(
            chat_id=query.message.chat_id,
            text=(
                "❤️‍🔥 𝗖𝗼𝗺𝗺𝗮𝗻𝗱: /yt ᴠɪᴅᴇᴏ ʟɪɴᴋ\n"
                "🗂️ 𝗔𝗯𝗼𝘂𝘁: ᴅᴏᴡɴʟᴏᴀᴅ𝚘𝚊𝚍 ʏᴏᴜᴛᴜʙᴇ ᴠɪᴅᴇᴏs\n"
                "🧩 𝗙𝗲𝗮𝘁𝘂𝗿𝗲𝘀: ᴜsᴇ ᴛʜᴇ /yt ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ɪɴᴛᴇʀᴀᴄᴛ ᴡɪᴛʜ ᴛʜᴇ ᴀᴅᴠᴀɴᴄᴇᴅ ʏᴏᴜᴛᴜʙᴇ ᴅᴏᴡɴʟᴏᴀᴅ ғᴇᴀᴛᴜʀᴇ.\n\n"
                "❤️‍🔥 𝗖𝗼𝗺𝗺𝗮𝗻𝗱: /insta 𝚟𝚍𝚘 / 𝚛𝚎𝚎𝚕 𝚕𝚒𝚗𝚔\n"
                "🗂️ 𝗔𝗯𝗼𝘂𝘁: ᴅᴏᴡɴʟᴏᴀᴅ ɪɴsᴛᴀɢʀᴀᴍ ᴠɪᴅᴇᴏs\n"
                "🧩 𝗙𝗲𝗮𝘁𝘂𝗿𝗲𝘀: ᴛʜᴇ /insta ᴄᴏᴍᴍᴀɴᴅ ᴇɴᴀʙʟᴇs ᴜsᴇʀs ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ɪɴsᴛᴀɢʀᴀᴍ ᴠɪᴅᴇᴏs ᴇғғᴏʀᴛʟᴇssʟʏ.\n\n"
                "❤️‍🔥 𝗖𝗼𝗺𝗺𝗮𝗻𝗱: /jokes\n"
                "🗂️ 𝗔𝗯𝗼𝘂𝘁: ɢᴇɴᴇʀᴀᴛᴇ ʜɪɴᴅɪ ᴊᴏᴋᴇs\n"
                "🧩 𝗙𝗲𝗮𝘁𝘂𝗿𝗲𝘀: With the /jokes ᴄᴏᴍᴍᴀɴᴅ, ʏᴏᴜ ᴄᴀɴ ɢᴇᴛ ʀᴀɴᴅᴏᴍ ʜɪɴᴅɪ ᴊᴏᴋᴇ.\n\n"
                "❤️‍🔥 𝗖𝗼𝗺𝗺𝗮𝗻𝗱: /gpt 𝚚𝚞𝚎𝚜𝚝𝚒𝚘𝚗\n"
                "🗂️ 𝗔𝗯𝗼𝘂𝘁: ɢᴇɴᴇʀᴀᴛᴇ ᴀɴsᴡᴇʀs ᴜsɪɴɢ GPT-4\n"
                "🧩 𝗙𝗲𝗮𝘁𝘂𝗿𝗲𝘀: ᴛʜᴇ /gpt ᴄᴏᴍᴍᴀɴᴅ ɪɴɪᴛɪᴀᴛᴇs ᴀɴ ɪɴᴛᴇʀᴀᴄᴛɪᴠᴇ ᴄᴏɴᴠᴇʀsᴀᴛɪᴏɴ ᴡɪᴛʜ ᴛʜᴇ ᴄʜᴀᴛ ɢᴘᴛ-4 ᴍᴏᴅᴇʟ. ᴜsᴇʀs ᴄᴀɴ ɪɴᴘᴜᴛ ǫᴜᴇʀɪᴇs ᴀɴᴅ ʀᴇᴄᴇɪᴠᴇ ɪɴᴛᴇʟʟɪɢᴇɴᴛ ʀᴇsᴘᴏɴsᴇs, ᴍᴀᴋɪɴɢ ᴛʜᴇ ᴄʜᴀᴛ ᴇxᴘᴇʀɪᴇɴᴄᴇ ᴍᴏʀᴇ ᴅʏɴᴀᴍɪᴄ ᴀɴᴅ ᴇɴɢᴀɢɪɴɢ."
            ),
            reply_markup=InlineKeyboardMarkup(
                [
                    [
...
""",
    ...
    dispatcher.add_handler(CallbackQueryHandler(new_callback, pattern="New_"))
